do
  local _ENV = _ENV
  package.preload["db.seed"] = function(...)
    local arg = _G.arg;
...
do
  local _ENV = _ENV
  package.preload["db.sqlschema"] = function(...)
    local arg = _G.arg;
    local sqlschema = {}
...
do
  local _ENV = _ENV
  package.preload["db.utils"] = function(...)
    local arg = _G.arg;
    local dbUtils = {}
...
do
  local _ENV = _ENV
  package.preload["dexi-core.candles"] = function(...)
    local arg = _G.arg;
...
do
  local _ENV = _ENV
  package.preload["dexi-core.dexi-core"] = function(...)
    local arg = _G.arg;
...
do
  local _ENV = _ENV
  package.preload["dexi-core.intervals"] = function(...)
    local arg = _G.arg;
    local intervals = {}
...
do
  local _ENV = _ENV
  package.preload["dexi-core.overview"] = function(...)
    local arg = _G.arg;
    local dbUtils = require('db.utils')
...
do
  local _ENV = _ENV
  package.preload["dexi-core.price-around"] = function(...)
    local arg = _G.arg;
    local sqlschema = require('db.sqlschema')
...
do
  local _ENV = _ENV
  package.preload["dexi-core.stats"] = function(...)
    local arg = _G.arg;
    local dbUtils = require('db.utils')
...
do
  local _ENV = _ENV
  package.preload["indicators.calc"] = function(...)
    local arg = _G.arg;
    local calc = {}
...
do
  local _ENV = _ENV
  package.preload["indicators.indicators"] = function(...)
    local arg = _G.arg;
    local dbUtils = require('db.utils')
...
do
  local _ENV = _ENV
  package.preload["ingest.ingest"] = function(...)
    local arg = _G.arg;
    local json = require('json')
...
do
  local _ENV = _ENV
  package.preload["ownable.ownable"] = function(...)
    local arg = _G.arg;
    local mod = {
      version = '1.2.1'
    }
...
do
  local _ENV = _ENV
  package.preload["subscriptions.subscriptions"] = function(...)
    local arg = _G.arg;
    local indicators = require('indicators.indicators')
    local topN = require('top-n.top-n')
...
do
  local _ENV = _ENV
  package.preload["top-n.top-n"] = function(...)
    local arg = _G.arg;
    local dbUtils = require('db.utils')
    local json = require('json')
...
do
  local _ENV = _ENV
  package.preload["utils.debug"] = function(...)
    local arg = _G.arg;
    local dbUtils = require('db.utils')
...
do
  local _ENV = _ENV
  package.preload["validation.validation"] = function(...)
    local arg = _G.arg;
    -- @file        validation.lua
...
do
  local _ENV = _ENV
  package.preload["validation.validation-schemas"] = function(...)
    local arg = _G.arg;
